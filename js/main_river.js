// import source files
import { calc_constants, timeSeriesData, loadConfig, init_sim_parameters } from './constants_load_calc_river.js';  // variables and functions needed for init_sim_parameters
...
import { displayCalcConstants, displaySimStatus, displayTimeSeriesLocations, displaySlideVolume, ConsoleLogRedirection} from './display_parameters_river.js';  // starting point for display of simulation parameters
...
async function initializeWebGPUApp(configContent, bathymetryContent, waveContent, OverlayFile) {
    ...
    const BoundaryPass_ShaderCode = await fetchShader('/shaders/BoundaryPass_river.wgsl');
    ...
    const ExtractTimeSeries_ShaderCode = await fetchShader('/shaders/ExtractTimeSeries_river.wgsl');
    ...
    const logo_left = await loadImage('./logo_USC_river.png');
    const logo_right = await loadImage('./logo_publicex_river.png');
