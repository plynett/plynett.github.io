// Handler_SedTrans_Pass1.js

export function create_SedTrans_Pass1_BindGroupLayout(device) {
...
export function create_SedTrans_Pass1_BindGroup(device, uniformBuffer, txState_Sed, txBottom, txH, txSed_C1, txSed_C2, txSed_C3, txSed_C4) {
    return device.createBindGroup({
        layout: create_SedTrans_Pass1_BindGroupLayout(device),
        entries: [
            {
                binding: 0,
                resource: {
